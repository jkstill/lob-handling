...
#line 162 "HexConverter.c"

XS_EUPXS(XS_Data__HexConverter_hex_to_bytes); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Data__HexConverter_hex_to_bytes)
{
    dVAR; dXSARGS;
    if (items < 1 || items > 2)
...
XS_EUPXS(XS_Data__HexConverter_hexsimd_hex2bin_impl_name); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Data__HexConverter_hexsimd_hex2bin_impl_name)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
...
XS_EUPXS(XS_Data__HexConverter_hexsimd_bin2hex_impl_name); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Data__HexConverter_hexsimd_bin2hex_impl_name)
{
    dVAR; dXSARGS;
    if (items != 0)
       croak_xs_usage(cv,  "");
